...
import { white, purple, pink,red, water, peach, CyanA200, CyanA300 } from "./colors";
...
const Styles = StyleSheet.create({
  ...
  AddCardinputContainer: {
    flex: 1,
    backgroundColor: Platform.OS === 'ios' ? yellow : CyanA200,
  ...
  Deckscontainer: {
    flex: 1,
    backgroundColor: Platform.OS === 'ios' ? white : CyanA300,
  },
  Decksheader: {
    fontFamily: Platform.OS === 'ios' ? 'Avenir Next' : 'sans-serif',
    fontSize: 36,
